...
//	private int typePanelIsRendering = 1;
	...
	public JHomeView() {
		...
		lbl_service.setFont(new Font("Segoe UI", Font.BOLD, 17));
		lbl_service.setBounds(65, 6, 77, 23);
		...
		lbl_lobby.setFont(new Font("Segoe UI", Font.BOLD, 17));
		lbl_lobby.setBounds(65, 6, 77, 23);
		...
		lbl_food.setFont(new Font("Segoe UI", Font.BOLD, 17));
		lbl_food.setBounds(65, 6, 77, 23);
		...
		lbl_wedding.setFont(new Font("Segoe UI", Font.BOLD, 17));
		lbl_wedding.setBounds(65, 6, 77, 23);
