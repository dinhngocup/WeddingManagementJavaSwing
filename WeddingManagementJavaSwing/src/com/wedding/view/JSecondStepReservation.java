...
public class JSecondStepReservation extends JPanel {
	...
	public JSecondStepReservation(Reservation reservation) {
		...
		txt_groom.setBounds(34, 130, 192, 20);
		add(txt_groom);
		...
		txt_bride.setBounds(267, 130, 192, 20);
		add(txt_bride);
		...
		txt_phone.setBounds(34, 216, 121, 20);
		add(txt_phone);
		...
		txt_table.setBounds(194, 216, 129, 20);
		add(txt_table);
